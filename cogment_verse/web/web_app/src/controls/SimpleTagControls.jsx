...
export const SimpleTagEnvironments = [
  "environments.mpe_adapter.Environment/pettingzoo.mpe.simple_tag_v2",
];
export const SimpleTagControls = ({ sendAction, observation, actorClass, ...props }) => {
